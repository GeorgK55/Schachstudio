...
function studieauswahl(context) {	if(logMe(LOGLEVEL_SLIGHT, LOGTHEME_FUNCTIONBEGINN)) console.log('Beginn in ' + getFuncName() + ' mit user ' + $('#lichessuser').val());
	...
	let currentuser = context == 'kapitel' ? $('#lichessusertext').val() : $('#lichessdialoguser').val();
...
function togglestudylist() { if(logMe(LOGLEVEL_SLIGHT, LOGTHEME_FUNCTIONBEGINN)) console.log('Beginn in ' + getFuncName());

	$('#lichessbenutzerhinweis').removeClass('hideMe');
	$("#studienliste").empty().addClass('hideMe');
...
function showstudylist(lichessitems, context) {	if(logMe(LOGLEVEL_SLIGHT, LOGTHEME_FUNCTIONBEGINN)) console.log('Beginn in ' + getFuncName());
	...
	if(context == 'kapitel') {
		...
		$('#lichessbenutzerhinweis').addClass('hideMe');
