$(document).ready(function () {
	...
	curLogthemes	= [LOGTHEME_FUNCTIONBEGINN, LOGTHEME_SPECIALSITUATION, LOGTHEME_SPECIALDATA];
	//curLogthemes	= [LOGTHEME_FUNCTIONBEGINN, LOGTHEME_SITUATION];
	//curLogthemes	= [LOGTHEME_FUNCTIONBEGINN, LOGTHEME_DATA];
