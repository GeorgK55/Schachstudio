function TheOriginalIndexWithLogFunction() {
    ...
    sf.addMessageListener(line => {
      ...
      if (line.startsWith("Fen: ")) {                  // Receive the latest board state
        if (line !== lastFen) {                        // The last move was valid
          ...
          console.log('-=-- tentativeGameMoves: ' + tentativeGameMoves);
          ...
          if (!playersTurn || aiMovingPlayer) {
            console.log('-=-- ' + 'go depth ' + currentDepth);
      ...
      console.log('-=-- ' + 'setoption name Skill Level value 1');
  ...
  function makeMove(input) {
    ...
    console.log('-=-- ' + tentativeGameMoves);
